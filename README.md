...
<img align="justify" width="380" src="https://raw.githubusercontent.com/abhisheknaiidu/abhisheknaiidu/master/code.gif"/>
...
<details>
<summary><b>📡 BSNL — Intern</b> &nbsp;|&nbsp; Telecom Network Operations</summary>
...
- 📡 Developed understanding of end-to-end telecom network architecture and fault management protocols.

</details>

<details>
<summary><b>🌬️ LEAP GREEN ENERGY Pvt. Ltd — Intern</b> &nbsp;|&nbsp; Renewable Energy & SCADA</summary>
...
- ⚡ Explored how renewable energy data is collected, processed, and visualized for operational decision-making.

</details>

<details>
<summary><b>🤖 IIT Madras — Workshop Participant</b> &nbsp;|&nbsp; AI & IoT</summary>
...
- 🔬 Explored intersections of AI and IoT in smart devices, automation, and data-driven systems.
...
| 🏆 | Achievement | Details |
|:--:|:-----------:|:-------:|
| 🥇 | **TECHPRAXIS 2025 — Triple Win & Overall Prize** | National-level technical event by IEEE Student Branch, Study World College of Engineering — won **3 events + Overall Prize** |
| 🌟 | **Dindigul Science Fest — Finalist & Special Appreciation** | Led a **team of 4**, became finalist; received appreciation from **Mr. Mayilsamy Annadurai** (Moon Man of India) & **Mr. Anbil Mahesh Poyyamozhi** (Ex-Education Minister) |
| 📜 | **Multiple Certifications** | Cisco CCNA · Coursera · Microsoft Azure · NPTEL |
...
|:---------:|:--------------:|:-------:|:--------:|
| B.E — Electronics & Communication Engineering | Sri Krishna College of Technology, Coimbatore | 2023 – 2027 | **CGPA: 7.70 / 10** |
...
```
🧱 Cloud Architecture     → AWS EC2 / S3 / Lambda · Microsoft Azure Functions · Serverless
🤖 Deep Learning          → Neural Networks · CNNs · TensorFlow · PyTorch
🏆 Competitive DSA        → Advanced Graph Algorithms · Dynamic Programming · System Design
🔗 Backend Engineering    → REST APIs · Microservices · Docker · CI/CD Pipelines
```
